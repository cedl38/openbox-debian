...
gboolean config_theme_titleless_maximize;
...
static void parse_theme(xmlNodePtr node, gpointer d)
{
    ...
    if ((n = obt_xml_find_node(node, "titlelessMaximize")))
        config_theme_titleless_maximize = obt_xml_node_bool(n);
...
void config_startup(ObtXmlInst *i)
{
    ...
    config_theme_titleless_maximize = FALSE;
